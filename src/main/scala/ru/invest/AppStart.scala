...
import ru.invest.service.{BusinessProcessServiceImpl, DataBaseServiceImpl, MonitoringServiceImpl, TinkoffRESTServiceImpl}
...
import ru.invest.AppStart.loggerForStream
...
trait AppStartHelper {
  ...
  val factory: OkHttpOpenApiFactory         = new OkHttpOpenApiFactory(TOKEN, loggerForStream)
